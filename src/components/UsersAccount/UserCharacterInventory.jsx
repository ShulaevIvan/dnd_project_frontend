...
import UserCharacterInventoryItemEquip from "./UserCharacterInventoryItemEquip";
...
const UserCharacterPreviewInventory = () => {
    ...
    }, [moneyTransferInputValue, moneyTransferInputRef.current, charMoneyTypes, moneyTransferToCharacterSend]);
    ...
    return (
        <React.Fragment>
            <div className="preview-character-inventory-wrap">
                ...
                <UserCharacterInventoryItemEquip />
                    ...
                    <div className="preview-character-inventory-money-row">
                        ...
                        <div className="preview-character-inventory-gold-transfer-wrap">
                            <span 
                                ...
                                onClick={() => addMoneyPopupHandler(true, 'plus')}
                            ></span>
                            <span 
                                className="inventory-gold-reduce-btn"
                                onClick={() => addMoneyPopupHandler(true, 'min')}
                            ></span>
                            <span 
